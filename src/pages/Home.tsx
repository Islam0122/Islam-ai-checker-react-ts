...
`;
    ...
    return (
        <>
            ...
            <div className="card">
                <p>Связь , GitHub  <a style={{color: "black"}} href='https://github.com/Islam0122'>Islam0122</a> ,  Telegram : <a style={{color: "black"}} href="https://t.me/islam_duishobaev">@islam_duishobaev</a>  Instagram:  <a style={{color: "black"}} href="https://www.instagram.com/duishobaevislam01">duishobaevislam01</a></p>
            </div>
        </>
    );
}